      ...
      <div tw="max-w-4xl">
        ...
        >
          <div tw="py-12 pl-12 z-10">
            ...
            <div tw="text-xl font-normal text-white mb-12 max-w-md">
              A short guide on making your first deploy on Dockoo in a couple
              of minutes.
            </div>
            <ButtonLink
        ...
        <div tw="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
          ...
          <OverviewLink href="#">
            ...
            <OverviewLinkTextbox tw="">
              ...
              <OverviewLinkText>
                Understand how Dockoo handles variables on the platform.
              </OverviewLinkText>
            </OverviewLinkTextbox>
          </OverviewLink>
          <OverviewLink href="#">
        ...
        <div tw="grid grid-cols-1 mt-14 items-center md:grid-cols-8">
          <div tw="bg-gray-100 rounded-md col-span-5 p-6">
            ...
            <div>
              ...
              <Link
                ...
                href="https://github.com/hisamafahri/dockoo"
              >
          ...
          <div tw="mt-8 flex flex-col ml-8 col-span-3 gap-4 md:mt-0">
            <OverviewSecondaryLink href="https://discord.gg/">
              <DiscordIcon tw="w-8 h-8" />
              <div>Join our Discord Server </div>
              <ArrowRight />
            </OverviewSecondaryLink>
            <OverviewSecondaryLink href="https://github.com/hisamafahri/dockoo">
              <RssIcon tw="w-8 h-8 text-pink-700" />
              Check out the Changelog <ArrowRight />
            </OverviewSecondaryLink>
            <OverviewSecondaryLink href="https://twitter.com/hisamafahri">
